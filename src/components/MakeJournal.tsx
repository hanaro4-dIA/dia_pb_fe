  ...
  return (
    <div className='flex flex-col border shadow-lg border-gray-200 w-full h-full rounded-t-lg'>
      ...
      <div className='p-3 border h-full flex flex-col justify-between'>
        <div className='flex flex-col justify-end mb-2'>
          ...
          <div className='flex justify-between items-center border-b border-black py-1'>
            ...
            <input
              ...
              maxLength={15}
              defaultValue={'title'}
              className='w-[85%] px-2 hover:bg-hanagold/30 focus:outline-none rounded-xl'
            />
          </div>
          <div className='flex justify-start items-center border-b border-black py-1 space-x-2'>
            <div className='flex items-center justify-between w-1/2'>
              ...
              <input
                ...
                maxLength={5}
                defaultValue={'카테고리'}
                className='w-2/3 px-2 hover:bg-hanagold/30 focus:outline-none rounded-xl'
              />
            </div>
            <div className='flex items-center justify-between w-1/2'>
        ...
        <div className='h-2/3 mb-3 mr-2 ml-2 '>
          <span>상담 스크립트</span>
          <div className='w-full h-full border resize-none overflow-y-auto'></div>
        </div>

        <div className='border border-green-600 flex flex-row justify-between mb-5 mr-2 ml-2'>
          첨부파일
        </div>
