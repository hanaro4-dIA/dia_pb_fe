...
export default function KeywordDB() {
          ...
          <div className="flex flex-col h-full bg-white rounded-lg shadow-lg border border-gray-200">
            ...
            <div className="mt-2 p-4 overflow-auto">
              {filteredDBList.map((item) => (
                <div key={item.id} className="mb-4" onClick={() => setSelectedItem(item)}>
          ...
          {selectedItem ? (
            <div className="p-10 space-y-4  overflow-y-auto">
              ...
              <div className='flex justify-between'>
                ...
                <div className='flex gap-3'>
                  <div className="text-lg font-extrabold">최근 업데이트 날짜 </div>
            ...
            <div className="m-5 flex justify-center text-lg">키워드를 선택해 주세요.</div>
          )}
        </div>
      </div>
    </div>
